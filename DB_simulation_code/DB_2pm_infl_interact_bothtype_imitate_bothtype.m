function result = DB_2pm_infl_interact_bothtype_imitate_bothtype(pm1, pm2, r, con_matrix, alpha, iter, N, p_ini, b)
...
% They also imitate both types of neighbors.
% 2020.01.05
% Yuejiang Li
% ==========================
% inputs:
        ...
        for p = 1:N
            ...
            for j = friend_list
                if action_table(j)
                    ...
                    sf_neigh_num = sf_neigh_num + 1;
                else
                    fit_n = fit_n + fit_table(j);
                    sn_neigh_num = sn_neigh_num + 1;
                end
            end
