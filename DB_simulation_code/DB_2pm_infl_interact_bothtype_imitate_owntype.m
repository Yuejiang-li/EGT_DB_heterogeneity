function result = DB_2pm_infl_interact_bothtype_imitate_owntype(pm1, pm2, r, con_matrix, alpha, iter, N, p_ini, b)
...
% But they only copy the strategy from neighbours who has the same type.
% 2020.01.08
% Yuejiang Li
% ==========================
% inputs:
