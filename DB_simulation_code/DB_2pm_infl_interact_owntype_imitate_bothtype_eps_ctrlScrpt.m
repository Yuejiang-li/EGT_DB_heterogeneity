function mean_result = DB_2pm_infl_interact_owntype_imitate_bothtype_eps_ctrlScrpt(pm1, pm2, r, N, k, alpha, iter, p_ini, b, g_type, varargin)
% repeated simulation control script for "DB_2pm_interact_owntype.m"
    ...
    for i = 1:rand_graph_num
        ...
        parfor j = 1: sim_run_num
            graph_result{1, j} = DB_2pm_infl_interact_owntype_imitate_bothtype_eps(pm1, pm2, r, graph, alpha, iter, N, p_ini, b);
        end
