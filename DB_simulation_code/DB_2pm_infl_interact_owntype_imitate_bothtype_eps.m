function result = DB_2pm_infl_interact_owntype_imitate_bothtype_eps(pm1, pm2, r, con_matrix, alpha, iter, N, p_ini, b)
...
% They imitate same type neighbours strategy with Prob. (1 - epsilon),
% and imitate different type neighbours strategy with Prob. epsilon.
% 2019.01.07
% Yuejiang Li
% ==========================
% inputs:
